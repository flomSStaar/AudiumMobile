        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if(method.equals("Album")) {
                    Log.i("DIM","Album");
                    if (AddAlbum.idTracksSelected.contains(titles.get(position))) {
                        AddAlbum.idTracksSelected.remove(titles.get(position));
                    } else {
                        AddAlbum.idTracksSelected.add(titles.get(position).getId());
                    }
